    ...
    <section class="container">
        <div class="profile">
            ...
            if ($userData) {
                ...
                // Adicionar link para criar evento
                echo '<a href="createEvent.php" class="create-event-link">Criar Evento</a>';
                echo '<a href="eventListManager.php" class="edit-event-link">Gerenciar Eventos</a>';
            } else {
