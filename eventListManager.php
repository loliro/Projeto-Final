...
<body>
    ...
    <section class="container">
        <div class="search-container">
            <form action="eventListManager.php" method="GET">
    ...
    <?php
        ...
        foreach ($res as $a) {
            echo ("
                <tr>
                    ...
                    <td><a href='editEvent.php?id={$a['id']}'>Edit</a></td>
                    <td><a href='formAction.php?window=delete&id={$a['id']}'>X</a></td>
                </tr>
        ...
        for ($i = 0; $i < $numPages; $i++) {
            echo ("<a href='eventListManager.php?page=$i'>" . ($i + 1) . "</a>&nbsp;&nbsp;");
        }
        echo '
            </div>
        </section>';
